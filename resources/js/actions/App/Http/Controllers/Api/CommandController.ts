...
* @route '/api/rover/commands/pending'
*/
...
pending.definition = {
    methods: ["get","head"],
    url: '/api/rover/commands/pending',
...
* @see app/Http/Controllers/Api/CommandController.php:48
...
complete.definition = {
    methods: ["post"],
    url: '/api/rover/commands/{command}/complete',
