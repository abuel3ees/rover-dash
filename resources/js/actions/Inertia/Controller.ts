...
* @route '/setup'
*/
const Controller2d4ca18360b2bcf78eaf4815fa03bc90 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller2d4ca18360b2bcf78eaf4815fa03bc90.url(options),
    method: 'get',
})

Controller2d4ca18360b2bcf78eaf4815fa03bc90.definition = {
    methods: ["get","head"],
    url: '/setup',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/setup'
*/
Controller2d4ca18360b2bcf78eaf4815fa03bc90.url = (options?: RouteQueryOptions) => {
    return Controller2d4ca18360b2bcf78eaf4815fa03bc90.definition.url + queryParams(options)
}
...
* @route '/setup'
*/
Controller2d4ca18360b2bcf78eaf4815fa03bc90.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller2d4ca18360b2bcf78eaf4815fa03bc90.url(options),
    method: 'get',
})
...
* @route '/setup'
*/
Controller2d4ca18360b2bcf78eaf4815fa03bc90.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller2d4ca18360b2bcf78eaf4815fa03bc90.url(options),
    method: 'head',
})
...
* @route '/setup'
*/
const Controller2d4ca18360b2bcf78eaf4815fa03bc90Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller2d4ca18360b2bcf78eaf4815fa03bc90.url(options),
    method: 'get',
})
...
* @route '/setup'
*/
Controller2d4ca18360b2bcf78eaf4815fa03bc90Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller2d4ca18360b2bcf78eaf4815fa03bc90.url(options),
    method: 'get',
})
...
* @route '/setup'
*/
Controller2d4ca18360b2bcf78eaf4815fa03bc90Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller2d4ca18360b2bcf78eaf4815fa03bc90.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
Controller2d4ca18360b2bcf78eaf4815fa03bc90.form = Controller2d4ca18360b2bcf78eaf4815fa03bc90Form
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
const Controller = {
    ...
    '/setup': Controller2d4ca18360b2bcf78eaf4815fa03bc90,
